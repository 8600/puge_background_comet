  ...
  <div id="container">
    ...
    <div id="trail">    
      <div id="stream">
        <div id="middle"></div>
        <div id="middleTrail">
          <div id="middleTrail1"></div>
          <div id="middleTrail1-b"></div>
          <div id="middleTrail2"></div>
          <div id="middleTrail2-b"></div>
          <div id="middleTrail3"></div>  
          <div id="middleTrail3-b"></div>
          <div id="middleTrail4"></div>
          <div id="middleTrail4-b"></div>
        </div>
      </div>
        <div id="streamTrail">
          <div id="steamTrail1"></div>
          <div id="streamTrail1-b"></div>
          <div id="streamTrail2"></div>
          <div id="streamTrail2-b"></div>
          <div id="streamTrail3"></div>
          <div id="streamTrail4"></div>
          <div id="streamTrail4-b"></div>
          <div id="streamTrail5"></div>
          <div id="streamTrail5-b"></div>
        </div>
      </div>
    <div id="planet">
      <div id="globe">
        <div id="innerGlobe">
            <div id="globeShadow"></div>
        </div>
      </div>
    </div>
  </div>
...
@keyframes glow{
  to{box-shadow: 0px 0px 10px 2px #E53D36;}
  to{left: 50%;}
  to{top: 7%;}
}
...
@keyframes a{
  to{left:100%;}
  20%{height:12px; width:12px;}
  40%{height:4px; width:4px;}
  60%{height:12px; width:12px;}
  80%{height:4px; width:4px;}
}
...
@keyframes c{
  to{left:100%;}
  20%{height:10px; width:10px;}
  40%{height:4px; width:4px;}
  60%{height:10px; width:10px;}
  80%{height:4px; width:4px;}
}
